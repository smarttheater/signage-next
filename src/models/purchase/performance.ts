...
export class Performance {
     ...
     * 販売判定
     */
    public isSales(status?: 'start' | 'end'): boolean {
     ...
     * 座席ステータス判定
     */
    public isSeatStatus(status?: 'success' | 'warning' | 'danger'): boolean {
        const screeningEvent = this.screeningEvent;
